...
void HelloOpenGL::initializeGL()
{
    ...
    texture1 = new QOpenGLTexture(QImage("../opengl2/image/wall.jpg").mirrored(),QOpenGLTexture::GenerateMipMaps);
    ...
    texture2 = new QOpenGLTexture(QImage("../opengl2/image/face.bmp").mirrored(),QOpenGLTexture::GenerateMipMaps);
    ...
    ourShader = new Shader(QString("../opengl2/shader/rect.vert"),QString("../opengl2/shader/rect.frag"));
    ourShader->use();
...
void HelloOpenGL::paintGL()
{
    ...
    QMatrix4x4 mat;
    //mat.scale(2);
    //mat.translate(0.3f,0.1f,0.0f);
    //mat.rotate(20.0f,QVector3D(0.0f,0.0f,1.0f));
    mat.rotate(QTime::currentTime().second(),QVector3D(0.0f,0.0f,1.0f));
