...
static QVector3D lightPos1(1.2f, 1.0f, -2.0f);
static QVector3D light(0.2f, 0.2f, 0.2f);
...
void HelloOpenGL::initializeGL()
{
    ...
    ourShader = new Shader(QString("../opengl6/shader/rect.vert"),QString("../opengl6/shader/rect.frag"));
    lightShader = new Shader(QString("../opengl6/shader/rect.vert"),QString("../opengl6/shader/light.frag"));
    ...
    core->glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, 6*sizeof (GLfloat), (void*)(3 * sizeof(float)));
    ...
    texture1 = new QOpenGLTexture(QImage("../opengl6/image/wall.jpg").mirrored(),QOpenGLTexture::GenerateMipMaps);
    ...
    texture2 = new QOpenGLTexture(QImage("../opengl6/image/face.bmp").mirrored(),QOpenGLTexture::GenerateMipMaps);
...
void HelloOpenGL::paintGL()
{
    ...
    //shaderProgram.bind();
    ourShader->use();
    QVector3D value = QVector3D(1.0f, 0.5f, 0.31f);
    ourShader->setVec3("objectColor", value);
    value = QVector3D(1.0f, 1.0f, 1.0f);
    ourShader->setVec3("lightColor", value);
    ourShader->setVec3("lightPos",lightPos);
    ourShader->setVec3("viewPos", camera->cameraPos);

    value = QVector3D(1.0f, 0.5f, 0.31f);
    ourShader->setVec3("material.ambient",  value);
    value = QVector3D(1.0f, 0.5f, 0.31f);
    ourShader->setVec3("material.diffuse",  value);
    value = QVector3D(0.5f, 0.5f, 0.5f);
    ourShader->setVec3("material.specular", value);
    ourShader->setFloat("material.shininess", 32.0f);

    value = QVector3D(0.2f, 0.2f, 0.2f);
    ourShader->setVec3("light.ambient", value );
    value = QVector3D(0.5f, 0.5f, 0.5f);
    ourShader->setVec3("light.diffuse", value ); // 将光照调暗了一些以搭配场景
    value = QVector3D(1.0f, 1.0f, 1.0f);
    ourShader->setVec3("light.specular",value );
